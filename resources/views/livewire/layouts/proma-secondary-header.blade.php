<div :class=" minPanel ? 'pl-0' : 'pl-0 lg:pl-4' " class="flex items-center py-2 h-12 w-full">
    {{-- Dashboard --}}
    ...
    <div class="{{ Request::is('proma-projects') ? 'flex w-full' : 'hidden' }}">
        <div class="flex items-center justify-between w-full">
            ...
            <div class="flex items-center gap-x-4">
                <button class="bg-[#89C09F] text-white font-semibold text-xs py-2 px-4 shadow-md rounded-md">
                ...
                <div class="bg-[#AAD2BA]/10 flex items-center rounded-md">
                    ...
                    <button @click=" tabledProjects = !tabledProjects "
                        class="bg-[#89C09F] p-2 rounded-md cursor-pointer">
                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                            <path fill="currentColor"
