...
<div class="bg-transparent absolute flex items-center justify-center w-full h-full ">
    <div class="bg-white flex flex-col items-center gap-y-4 p-8 w-full max-w-[375px] h-[560px] shadow-lg rounded-xl">
        {{-- Header --}}
        <div class="flex flex-col items-center gap-y-4 px-4 w-full">
            <h1 class="font-extrabold text-3xl">Sign Up</h1>
            <h2 class="font-semibold text-sm text-center">Create an account and start managing your projects with your
                team.</h2>
        </div>
        {{-- Form --}}
        ...
        <div class="font-semibold text-xs flex flex-col gap-y-4 w-full">
            ...
            <div class="flex items-center justify-center w-full">
                <h2>Already have an account? <a href="{{ route('proma-signin') }}" class="font-bold text-[#89C09F]">Sign
                        in</a> </h2>
            </div>
        </div>
    </div>
