...
<div :class="[(minPanel ? 'px-2 md:px-6' : 'px-6 lg:px-10'), (tabledProjects ? 'py-5 ' : 'flex py-5 ')] "
    class="bg-[#FAFAFA] flex-col  w-full h-[720px] ">
    {{-- Floating View --}}
    <div :class=" tabledProjects ? 'h-0 overflow-hidden gap-y-0 py-0 px-0' : 'flex w-full h-full overflow-hidden' "
        class=" gap-y-10 transition-all duration-300 ease-linear">
        {{-- Top --}}
        <div class="flex flex-col gap-y-5 w-full">
            {{-- Header --}}
            <div class="font-bold text-sm flex items-center justify-between pr-10 w-full">
            ...
            <div class="flex items-center gap-x-2 w-full ">
                <div class=" flex items-center gap-x-6 w-full max-w-full overflow-x-auto md:overflow-x-visible ">
                    {{-- 1 --}}
                    <div class=" border-2 border-[#F5F5F5] flex flex-col p-4 w-full h-[340px] min-w-[250px] max-w-[250px] shadow-lg rounded-xl
    ...
    {{-- Table View --}}
    <div :class=" tabledProjects ? 'h-full overflow-auto' : 'w-0 h-0 overflow-hidden' "
        class="flex transition-all duration-300 ease-linear max-h-[680px] ">
