<div x-data="{addTask : false, taskDetail : false, taskOptions : false}"
    ...
    <div class="flex justify-between ">
        <h4 class="font-semibold text-base">Approval</h4>
                ...
                <div
                    ...
                    <div class="flex justify-between font-semibold text-sm ">
                        <div class="flex items-center gap-x-1">
                            ...
                            <p x-text="approval.taskTitle"></p>
                        </div>
                        {{-- Show modal options --}}
                        <div class="relative">
                            <button @click="taskOptions = !taskOptions; activeTask = approval.id"
                            ...
                            {{-- Task detail modal --}}
                            <livewire:proma.projects.tasks.approval.approval-task-details />
                        </div>
                    </div>
                    {{-- Body --}}
                    ...
                    {{-- Sample --}}
                    <span class="font-semibold text-sm" x-text="approval.taskDate"></span>
                </div>
            </template>
        </div>
        {{-- Add Task --}}

        <livewire:proma.projects.tasks.approval.add-approval-task />
    </div>
</div>