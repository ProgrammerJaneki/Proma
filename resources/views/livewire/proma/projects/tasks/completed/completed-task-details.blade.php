{{-- Modal Options --}}
<template x-if="taskOptions && activeTask === complete.id">
    <div
        class="bg-white border-2 border-[#F5F5F5] absolute font-semibold z-50 text-sm right-0 sm:right-0 rounded-md   w-[150px]">
        {{-- Edit Name --}}
        <button
        ...
        {{-- Complete task --}}
        <button
            class="bg-white hover:bg-[#FAFAFA] text-[#89C09F] flex items-center gap-x-2 p-2 w-full whitespace-nowrap transition duration-150 ease-linear">
            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet"
                viewBox="0 0 1024 1024">
                <path fill="currentColor"
        ...
        <div class="relative">
            {{-- Floated Details --}}
            <div x-cloak x-show="taskDetail && activeTask === complete.id"
                ...
                <div x-show="taskDetail" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div x-data="{togglePrivacy : false}"
                        ...
                        {{-- Close button --}}
                        <button
                            class=" ring-2 ring-[#89C09F] text-[#89C09F] flex items-center gap-x-2 py-2 px-4 rounded-md transition duration-150 ease-linear">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet"
                                viewBox="0 0 1024 1024">
                                <path fill="currentColor"
                                    d="M699 353h-46.9c-10.2 0-19.9 4.9-25.9 13.3L469 584.3l-71.2-98.8c-6-8.3-15.6-13.3-25.9-13.3H325c-6.5 0-10.3 7.4-6.5 12.7l124.6 172.8a31.8 31.8 0 0 0 51.7 0l210.6-292c3.9-5.3.1-12.7-6.4-12.7z" />
                    ...
                    <div class="p-4 space-y-2.5">
                        ...
                        <div class="font-bold text-xl">
                            <input type="text" :value="complete.taskTitle"
                        ...
                        <div>
                            ...
                            <div class="flex items-center px-2 gap-x-2">
                                ...
                                <input type="text" :value="complete.assignee"
                                    class="text-[#1B212D] p-2 focus:ring-2 ring-[#89C09F] focus:outline-none w-full rounded-md">
                            </div>
                        </div>
                        {{-- Due date --}}
                        <div>
                            ...
                            <div class="flex items-center px-2 gap-x-2">
                                ...
                                <input type="text" :value="complete.taskDate"
                                    class="text-[#1B212D] p-2 focus:ring-2 ring-[#89C09F] focus:outline-none w-full rounded-md">
                            </div>
                        </div>
                        {{-- task detail --}}
            ...
            <button @click="taskDetail = !taskDetail; activeTask = complete.id"
                class="bg-white hover:bg-[#FAFAFA] flex items-center gap-x-2 p-2 w-full whitespace-nowrap transition duration-150 ease-linear">
                <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet"
                    viewBox="0 0 1024 1024">
                    <path fill="currentColor"
        ...
        <div class="border-t-2 border-[#F5F5F5] ">
            <button @click="deleteCompleted(complete)"
