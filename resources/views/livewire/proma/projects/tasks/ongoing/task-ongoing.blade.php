<div x-data="{addTask : false, taskDetail : false, taskOptions : false}" class="bg-transparent space-y-2 w-[330px] sm:w-[250px] max-h-[500px] sm:h-[720px] sm:max-h-[720px] px-2 hover:overflow-y-auto scrollbar-thin  sm:scrollbar-thumb-gray-400 scrollbar-track-gray-200 
    ...
    <div class="w-full space-y-2 rounded-md">
        {{-- Available Tasks --}}
        <div class="space-y-2">
            <template x-for="(ongoing, index) in ongoings" :key="ongoing.id">
                <div
                    ...
                    <div class="flex justify-between font-semibold text-sm ">
                        ...
                        <div class="relative">
                            ...
                            {{-- Task detail modal --}}
                            <livewire:proma.projects.tasks.ongoing.ongoing-task-details />
                        </div>
                    </div>
                    {{-- Body --}}
                    ...
                    {{-- Sample --}}
                    <span class="font-semibold text-sm" x-text="ongoing.taskDate"></span>
                </div>
            </template>
        </div>
        {{-- Add Task --}}

        <livewire:proma.projects.tasks.ongoing.add-ongoing-task />
    </div>
</div>